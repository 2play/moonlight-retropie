...
echo -e " * 1: Install Moonlight & System Menu - Stretch OS"
echo -e " * 2: Install Moonlight & System Menu - Jessie OS"
echo -e " * 3: Remove Steam Launch Scripts"
echo -e " * 4: Install Steam Launch Scripts"
